...
Prompt / Dataset / Model は 02_assets.ipynb の流れに合わせています。
Score は既存の Scorer 教材の内容を踏襲しています。
"""
...
# =============================================================================
# 7. Built-in Scorers - Weave提供のスコアラー
# =============================================================================
print("\n" + "=" * 60)
print("7. Built-in Scorers")
print("=" * 60)
...
print("=" * 60)
print(f"\n登録したアセットは {ASSETS_FILE} に保存されました")
print("\n次のステップ:")
print("- 3_1_evaluation.py で評価を実行")
