"""
2_2: Dataset Management

What you'll learn in this script:
================================
1. Creating and publishing Datasets
2. Dataset version management
3. Loading and using datasets
"""
...
print("=" * 60)
print(f"\nRegistered datasets saved to {ASSETS_FILE}")
print("Check them in the Objects tab in Weave UI")
