...
- `1_2_2_multimodal_openai` マルチモーダル - OpenAI (画像, 音声, PDF)
- `1_2_2_multimodal_gemini` マルチモーダル - Gemini (画像, 音声, 動画, PDF)
...
- `2_4` Scorer 作成 (カスタムScorer, Built-in Scorers, LLM as a Judge)
...
```
jp/
├── config_loader.py                # LLM設定ローダー (OpenAI/Gemini 切り替え)
├── 1_1_0_basic_trace.py            # 基本的なトレーシング
├── 1_2_1_agent_sdk.py              # Agent SDK
├── 1_2_2_multimodal_openai.py      # マルチモーダル - OpenAI (画像, 音声, PDF)
├── 1_2_2_multimodal_gemini.py      # マルチモーダル - Gemini (画像, 音声, 動画, PDF)
...
├── 3_1_offline_evaluation.py      # オフライン評価 (weave.Evaluation)
├── 3_2_evaluation_logger.py       # EvaluationLogger (柔軟なバッチ評価)
├── 3_3_online_feedback.py         # オンラインフィードバック
└── 3_4_guardrail_monitoring.py    # ガードレールとモニタリング
